...
export function Sidebar({ mobileOpen, onMobileClose }: SidebarProps) {
  ...
  const { org, workerLabelPlural } = useOrgContext()
  ...
  const navItems: NavItem[] = [
    ...
    { label: workerLabelPlural, href: '/dashboard/technicians', icon: <Users className="w-5 h-5" /> },
  ...
  const orgName = org?.name || 'Tools Admin'
