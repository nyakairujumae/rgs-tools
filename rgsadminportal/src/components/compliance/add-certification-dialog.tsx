...
import { addCertification } from '@/lib/supabase/actions'
...
export function AddCertificationDialog({ open, tools, onClose, onSuccess }: AddCertificationDialogProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault()
    if (!form.tool_id || !form.certification_type || !form.certification_number.trim()) return
    setSaving(true)
      ...
      <div className="bg-card border border-border rounded-xl w-full max-w-[520px] mx-4 shadow-xl max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="p-4 space-y-4">
          ...
          <div className="flex justify-end gap-3 pt-2">
            ...
            <button
              type="submit"
              disabled={saving || !form.tool_id || !form.certification_type || !form.certification_number.trim()}
