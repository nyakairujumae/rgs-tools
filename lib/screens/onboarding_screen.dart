...
class _OnboardingScreenState extends State<OnboardingScreen>
  ...
  void _getStarted() {
    Navigator.of(context).push(
      MaterialPageRoute(builder: (_) => const AdminOnboardingWizardScreen()),
    );
  }
  ...
  Widget build(BuildContext context) {
    return _Card(
      child: AnimatedBuilder(
        animation: _ctrl,
        builder: (_, __) {
          // Phase 0–0.4: show tool card
          // Phase 0.4–0.7: dot travels down
          // Phase 0.7–1.0: show assigned state
          final t = _ctrl.value;
