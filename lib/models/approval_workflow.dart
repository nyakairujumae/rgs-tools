    ...
    return [
      ApprovalWorkflow(
        ...
        requestData: {
          ...
          'project': 'Site A Installation',
        },
      ),
      ApprovalWorkflow(
        id: '2',
        requestType: RequestTypes.toolPurchase,
        title: 'Purchase New Multimeter Set',
        description: 'Request to purchase 5 new digital multimeters for upcoming projects',
        requesterId: 'REQ-002',
      ...
      ApprovalWorkflow(
        ...
        title: 'Maintenance for Cordless Drill',
        description: 'Request for annual maintenance of Cordless Drill (Serial: CD789012)',
        requesterId: 'REQ-003',
